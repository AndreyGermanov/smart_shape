...
describe('SmartShapeManager import/export', () => {
  ...
  it('fromGeoJson raw data', () => {
    cy.visit('http://localhost:5173/tests/empty.html').then(() => {
      ...
      assert.equal(obj.top,2.049574476999908,"Should have correct left corner value");
      assert.equal(obj.left,40.95728600400008,"Should have correct flipped top corner value");
      assert.equal(obj.bottom,2.197360934999949,"Should have correct right corner value");
      assert.equal(obj.right,41.09888756600009,"Should have correct flipped right corner value");
      assert.equal(obj.width,0.1416015620000053,"Should have correct width");
      assert.equal(obj.height,0.14778645800004098, "Should have correct height");
      ...
      assert.equal(child1.top,-33.18122531500005,"Should have correct left corner value");
      assert.equal(child1.left,11.456540567000076,"Should have correct flipped top corner value");
      assert.equal(child1.bottom,-32.90210133900011,"Should have correct right corner value");
      assert.equal(child1.right,11.50604659000004,"Should have correct flipped right corner value");
      assert.equal(child1.width,0.04950602299996376,"Should have correct width");
      assert.equal(child1.height,0.2791239759999371, "Should have correct height");
      ...
      assert.equal(child2.bottom,2.049574476999908,"Should have correct left corner value");
      assert.equal(child2.right,41.12273196700005,"Should have correct flipped top corner value");
      assert.equal(child2.top,2.036309502999927,"Should have correct right corner value");
      assert.equal(child2.left,41.05396569100009,"Should have correct flipped right corner value");
      assert.equal(child2.width,0.06876627599996255,"Should have correct width");
      assert.equal(child2.height,0.013264973999980612, "Should have correct height");
