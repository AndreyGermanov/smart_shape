...
const r = new ot(), nt = (e) => e * (Math.PI / 180), ht = (e) => e * (180 / Math.PI), O = (e, t, i, s, o) => {
  const n = nt(e), h = (t - s) * Math.cos(n) - (i - o) * Math.sin(n) + s, l = (t - s) * Math.sin(n) + (i - o) * Math.cos(n) + o;
  return [h, l];
}, B = (e, t, i, s) => Math.sqrt(Math.pow(i - e, 2) + Math.pow(s - t, 2)), rt = (e, t, i, s, o, n) => {
...
function xt(e, t, i) {
  ...
  return i.isMergeableObject(e) && F(e).forEach(function(o) {
    ...
    St(e, o) || (X(e, o) && i.isMergeableObject(t[o]) ? s[o] = mt(o, i)(e[o], t[o], i) : s[o] = D(t[o], i));
  }), s;
}
const R = (e, t, i) => {
  ...
  return s === o ? s ? i.arrayMerge(e, t, i) : xt(e, t, i) : D(t, i);
};
R.all = function(t, i) {
  if (!Array.isArray(t))
...
function Pt() {
  this.menus = [], this.create = (e, t, i = "contextmenu", s = {}) => new Bt(e, t, i, s).init(), y.subscribe(I.CREATE, (e) => {
...
function Zt() {
  return this.options = {
    ...
    forceDisplay: !1,
    createDOMElement: !1
  }, this.x = 0, this.y = 0, this.element = null, this.guid = U(), this.subscriptions = {}, this.dragHorizontal = !1, this.dragVertical = !1, this.init = (e, t, i = null) => (this.x = parseInt(e), this.y = parseInt(t), this.setOptions(S({}, i)), this.setEventListeners(), r.emit(c.POINT_ADDED, this), this), this.setOptions = (e) => {
    if (e && typeof e == "object" && (m(e.moveDirections) && typeof e.moveDirections == "object" && (this.options.moveDirections = []), this.options = S(this.options, e)), Object.assign(this, new Q(this)), !this.element)
  ...
  }, this.distance = (e) => B(this.x, this.y, e.x, e.y), this;
}
const c = {
  POINT_ADDED: "create",
...
function Jt(e) {
  ...
  }, this.calcHypotenuse = (t, i, s, o) => B(t, i, s, o), this.calcCathetus = (t, i, s, o) => {
    if (t <= s && i <= o)
      return B(t, i, t, o);
    if (t >= s && i <= o)
      return B(t, i, s, i);
...
function $t() {
  this.draw = (e) => {
    ...
    e.points.length < 1 || (e.options.hasContextMenu && e.shapeMenu && !e.shapeMenu.contextMenu && e.shapeMenu.updateContextMenu(), this.updateOptions(e), !t || !t.options.displayAsPath ? this.drawPolygon(e) : t && t.options.displayAsPath && t.guid !== e.guid && this.draw(t));
    ...
    e.points.filter((i) => i.element).forEach((i) => {
      i.element.parentNode !== e.root && e.root.appendChild(i.element), i.options.zIndex = e.options.zIndex + 2, e.options.visible || (i.options.visible = !1), i.redraw(), e.options.displayMode === u.DEFAULT && !i.options.forceDisplay && (!t || t.options.displayMode === u.DEFAULT) && (i.element.style.display = "none");
    });
  }, this.drawPolygon = (e) => {
    ...
    return i.setAttribute("viewBox", o), t && !e.options.groupChildShapes && e.getChildren(!0).filter((n) => n.svg).forEach((n) => {
      Array.from(n.svg.querySelector("defs").children).forEach((l) => {
        i.querySelector("defs").appendChild(l.cloneNode(!0));
      });
      const h = n.svg.querySelector("path").cloneNode(!0);
      h.setAttribute("d", this.getPolygonPathForShape(n, s, this.getMaxStrokeWidth(n))), i.appendChild(h);
    }), i;
...
const V = {
  ...
  let o = se(e, t, i);
  o.visible = !1;
  const { polygons: n, origPolygons: h, offsetX: l, offsetY: p } = oe(e);
  ...
  const i = { polygons: [], origPolygons: t.map((s) => S({}, s[0])) };
...
function ne() {
  this.shapes = {}, this.visibleShapes = {}, this.activeShape = null, this.draggedShape = null, this.shapeOnCursor = null, this.containerEventListeners = [], this.init = () => (this.setEventListeners(), this), this.setEventListeners = () => {
    ...
    typeof e.options.prevZIndex < "u" && M.updateOptions(e), e.options.displayMode !== u.DEFAULT && e.switchDisplayMode(u.DEFAULT), e.options.groupChildShapes && e.getChildren(!0).forEach((t) => {
      typeof t.options.prevZIndex < "u" && (M.updateOptions(t), t.options.displayMode !== u.DEFAULT && t.switchDisplayMode(u.DEFAULT));
    });
  }, this.addContainerEvents = (e) => {
    this.addContainerEvent(e.root, "mousemove", this.mousemove), this.addContainerEvent(e.root, "mouseup", this.mouseup, e.options.id), this.addContainerEvent(e.root, "dblclick", this.doubleclick), this.addContainerEvent(e.root, "contextmenu", this.contextmenu), r.emit(he.MANAGER_ADD_CONTAINER_EVENT_LISTENERS, e.root);
    ...
    this.shapeOnCursor && this.shapeOnCursor !== s && this.shapeOnCursor.getShapeSvg() && (this.shapeOnCursor.getShapeSvg().style.cursor = "default", this.shapeOnCursor.eventListener.mouseout(A(e, { target: this.shapeOnCursor }))), s && s !== this.shapeOnCursor && s.eventListener.mouseover(A(e, { target: s })), this.shapeOnCursor = s, this.shapeOnCursor && (r.emit(a.SHAPE_MOUSE_MOVE, this.shapeOnCursor, A(e)), this.shapeOnCursor.getShapeSvg().style.cursor = "crosshair");
  ...
  }, this.fromGeoJson = (e, t, i = {}, s = null) => te(e, t, i, s), this.length = () => Object.values(this.shapes).length;
}
const he = {
...
function et(e) {
  this.shape = e, this.addChild = (t) => {
    !this.shouldAddChild(t) || (this.shape.options.displayMode !== t.options.displayMode && (t.svg ? t.switchDisplayMode(this.shape.options.displayMode) : t.options.displayMode = e.options.displayMode), this.shape.children.push(t), r.emit(a.SHAPE_ADD_CHILD, this.shape, { child: t }));
  }, this.removeChild = (t) => {
...
function it() {
  this.left = 0, this.top = 0, this.right = 0, this.bottom = 0, this.width = 0, this.height = 0, this.shape = null, this.guid = U(), this.options = {
    ...
    zIndex: 1e3
  }, this.eventListener = null, this.left_top = null, this.left_bottom = null, this.right_top = null, this.right_bottom = null, this.init = (e, t, i, s, o, n = {}) => (this.left = parseInt(t), this.top = parseInt(i), this.width = parseInt(s), this.height = parseInt(o), this.right = this.left + this.width, this.bottom = this.top + this.height, this.setOptions(n), this.options.shapeOptions.id = this.options.id, this.options.shapeOptions.canRotate = !1, this.options.shapeOptions.canScale = !1, this.shape = new P().init(e, S({}, this.options.shapeOptions), []), r.emit(a.SHAPE_CREATE, this.shape, {}), this.options.shapeOptions.pointOptions.bounds = this.shape.getBounds(), this.addPoints(), this.eventListener = new Jt(this).run(), this.redraw(), this), this.setOptions = (e = {}) => {
    !e || typeof e != "object" || (this.options = S(this.options, e), this.options.shapeOptions.zIndex = this.options.zIndex || this.options.zIndex, this.options.shapeOptions.id = this.options.id ? this.options.id : this.options.id, this.shape && this.shape.setOptions(this.options.shapeOptions));
  }, this.addPoints = () => {
...
function re(e) {
  this.shape = e, this.contextMenu = null, this.updateContextMenu = () => {
    ...
    const t = [
      ...
      { id: "i" + e.guid + "_move_to_bottom", title: "Move to Bottom", image: Xt },
    ...
    this.contextMenu.on("click", (s) => {
      switch (s.itemId) {
        ...
        case "i" + this.shape.guid + "_group":
          i = this.shape.getRootParent(), t = i || this.shape, t.setOptions({ groupChildShapes: !0 }), t.switchDisplayMode(u.DEFAULT);
          break;
        case "i" + this.shape.guid + "_ungroup":
          i = this.shape.getRootParent(), t = i || this.shape, t.setOptions({ groupChildShapes: !1 }), t.switchDisplayMode(u.DEFAULT), t.getChildren(!0).forEach((o) => o.redraw());
          break;
...
function P() {
  this.root = null, this.points = [], this.svg = null, this.groupHelper = null, this.eventListener = new qt(this), this.options = {
    ...
    return this.root = e, this.root.style.position = "relative", this.shapeMenu = new re(this), this.setOptions(t), this.groupHelper = new et(this), i && i.length && (this.setupPoints(i, S({}, this.options.pointOptions)), this.redraw()), this.eventListener.run(), this.shapeMenu && typeof this.shapeMenu == "object" && this.shapeMenu.updateContextMenu(), s && this.applyDisplayMode(), (i && i.length || this.options.forceCreateEvent) && r.emit(a.SHAPE_CREATE, this, {}), this;
  }, this.setOptions = (e) => {
    !e || typeof e != "object" || (m(e.visible) && e.visible !== this.options.visible && (this.points.filter((t) => typeof t.setOptions == "function").forEach((t) => t.options.visible = e.visible), this.resizeBox && this.resizeBox.setOptions({ shapeOptions: { visible: e.visible } }), this.rotateBox && this.rotateBox.setOptions({ shapeOptions: { visible: e.visible } })), m(e.fillGradient) && (this.options.fillGradient = {}), m(e.fillImage) && (this.options.fillImage = {}), this.options = S(this.options, e), this.points.filter((t) => typeof t.setOptions == "function").forEach((t) => {
    ...
    this.points = [], this.isNewObject = !0, this.addPoints(e, S({}, t)), this.isNewObject = !1, this.calcPosition();
  }, this.addPoint = (e, t, i = {}) => {
    let s = this.putPoint(e, t, S({}, this.options.pointOptions, i));
    if (!s)
      return null;
    if (this.options.displayMode !== u.DEFAULT && (i.createDOMElement = !0), s = s.init(e, t, i), s.element) {
      try {
    ...
    let o = this.putPoint(e, t, S({}, this.options.pointOptions, s), i);
    if (!o)
      return null;
    this.options.displayMode !== u.DEFAULT && (s.createDOMElement = !0), o = o.init(e, t, s);
    try {
    ...
    !e || typeof e != "object" || (this.options.simpleMode ? this.points = e.map((i) => ({ x: i[0], y: i[1] })) : this.points = e.map((i) => {
      this.options.displayMode !== u.DEFAULT && (t.createDOMElement = !0);
    ...
    const n = new Zt();
    return n.x = e, n.y = t, this.options.displayMode !== u.DEFAULT && (i.createDOMElement = !0), n.setOptions(i), s && o !== -1 ? this.points.splice(o, 0, n) : this.points.push(n), n;
    ...
    if (!i || !i.length)
      return null;
    const s = i.map(([o, n]) => ({ x: o, y: n, d: B(e, t, o, n) })).reduce((o, n) => o.d < n.d ? o : n);
    ...
    for (let o in this.points)
      this.points[o].x += e, this.points[o].y += t, i && typeof this.points[o].redraw == "function" && this.points[o].redraw();
    this.calcPosition();
    ...
    l && l.options.groupChildShapes && ([n, h] = l.getCenter(l.options.groupChildShapes)), t || (t = n), i || (i = h), this.initCenter && ([t, i] = this.initCenter), !(s && (!this.isInBounds(...O(e, o.left, o.top, t, i)) || !this.isInBounds(...O(e, o.right, o.top, t, i)) || !this.isInBounds(...O(e, o.left, o.bottom, t, i)) || !this.isInBounds(...O(e, o.right, o.bottom, t, i)))) && (this.points.forEach((p) => {
      typeof p.rotateBy == "function" ? p.rotateBy(e, t, i) : [p.x, p.y] = O(e, p.x, p.y, t, i);
    }), this.options.groupChildShapes && this.getChildren(!0).forEach((p) => {
      p.points.forEach((d) => {
        typeof d.rotateBy == "function" ? d.rotateBy(e, t, i) : [d.x, d.y] = O(e, d.x, d.y, t, i);
      }), p.redraw();
    }));
  }, this.flip = (e, t, i) => {
    if (!e && !t)
    ...
    (!e || !e.options.groupChildShapes) && (this.options.displayMode === u.SCALE && this.options.canScale ? (this.rotateBox && this.rotateBox.hide(), !this.resizeBox && this.setupResizeBox(), this.resizeBox && this.resizeBox.setOptions({ shapeOptions: { visible: this.options.visible } })) : this.options.displayMode === u.ROTATE && this.options.canRotate ? (this.resizeBox && this.resizeBox.hide(), !this.rotateBox && this.setupRotateBox(), this.rotateBox && this.rotateBox.setOptions({ shapeOptions: { visible: this.options.visible } })) : (this.resizeBox && this.resizeBox.hide(), this.rotateBox && this.rotateBox.hide())), this.points.filter((t) => typeof t.setOptions == "function").forEach((t) => {
      const i = { zIndex: this.options.zIndex + 2 };
      this.options.displayMode === u.DEFAULT ? i.createDOMElement = !1 : i.createDOMElement = !0, t.setOptions(i), t.element && (t.element.style.zIndex = t.options.zIndex, this.options.displayMode === u.DEFAULT && !t.options.forceDisplay && (t.element.style.display = "none"));
    ...
    e || (e = this.getNextDisplayMode()), (e === u.SCALE && !this.options.canScale || e === u.ROTATE && !this.options.canRotate || e === u.SELECTED && this.points.length && !this.options.pointOptions.canDrag) && (e = u.DEFAULT), this.options.displayMode = e, this.redraw(), e === u.DEFAULT && this.options.groupChildShapes && setTimeout(() => {
      this.getChildren(!0).forEach((t) => t.switchDisplayMode(e));
    }, 10);
  }, this.getNextDisplayMode = () => {
    let e;
    return this.options.displayMode === u.DEFAULT ? e = u.SELECTED : this.options.displayMode === u.SELECTED ? e = u.SCALE : this.options.displayMode === u.SCALE ? e = u.ROTATE : e = u.DEFAULT, e === u.SELECTED && !this.options.pointOptions.canDrag && (e = u.SCALE), e === u.SCALE && !this.options.canScale && (e = u.ROTATE), e === u.ROTATE && !this.options.canRotate && (e = u.DEFAULT), e;
  }, this.calcPosition = () => {
  ...
  }, this.getShapeSvg = () => M.getShapeSvg(this), this.toSvg = (e = null) => M.toSvg(this, e), this.toPng = (e = V.DATAURL, t = null, i = null, s = null) => M.toPng(this, e, t, i, s), this.toJSON = (e = !0, t = !1) => JSON.stringify(this.getJSON(e, t)), this.clone = (e = {}, t = !0) => {
    const i = S({}, this.getJSON(t));
    i.parent_guid = this.guid, i.options = S(i.options, e);
    ...
    if (i.options.displayMode = u.DEFAULT, t || this.options.compactExport ? i.points = this.points.map((s) => [s.x, s.y]) : i.points = this.points.filter((s) => typeof s.getJSON == "function").map((s) => s.getJSON()), e) {
  ...
  }, this.addChild = (e) => this.groupHelper.addChild(e), this.removeChild = (e) => this.groupHelper.removeChild(e), this.removeAllChildren = (e = !1) => this.groupHelper.removeAllChildren(e), this.getChildren = (e = !1) => this.groupHelper.getChildren(e), this.hasChild = (e, t = !1) => this.groupHelper.hasChild(e, t), this.getParent = () => this.groupHelper.getParent(), this.getRootParent = (e = null) => this.groupHelper.getRootParent(e), this.getParentsList = (e = []) => this.groupHelper.getParentsList(e);
}
const u = {
  DEFAULT: "default",
  SELECTED: "selected",
