...
const r = new ot(), nt = (e) => e * (Math.PI / 180), ht = (e) => e * (180 / Math.PI), B = (e, t, i, s, o) => {
  ...
  const i = (p, d, g) => d.x <= Math.max(p.x, g.x) && d.x >= Math.min(p.x, g.x) && d.y <= Math.max(p.y, g.y) && d.y >= Math.min(p.y, g.y), s = (p, d, g) => {
    ...
    let V = s(p, d, g), w = s(p, d, b), x = s(g, b, p), C = s(g, b, d);
    return V !== w && x !== C || V === 0 && i(p, g, d) || w === 0 && i(p, b, d) || x === 0 && i(g, p, b) ? !0 : !!(C === 0 && i(g, d, b));
  };
  if (e.length < 3)
    return !1;
...
function xt(e, t, i) {
  ...
  return i.isMergeableObject(e) && F(e).forEach(function(o) {
    ...
    St(e, o) || (X(e, o) && i.isMergeableObject(t[o]) ? s[o] = mt(o, i)(e[o], t[o], i) : s[o] = _(t[o], i));
  }), s;
}
const R = (e, t, i) => {
...
function Kt() {
  return this.options = {
    ...
    if (e && typeof e == "object" && (m(e.moveDirections) && typeof e.moveDirections == "object" && (this.options.moveDirections = []), this.options = S(this.options, e)), Object.assign(this, new j(this)), !this.element)
    ...
    r.emit(c.POINT_MOUSE_DOWN, this, u(e)), e.buttons === 1 && this.options.canDrag && (r.emit(c.POINT_DRAG_START, this, u(e)), J(e));
  }, this.mousemove = (e) => {
...
function te(e) {
  this.shape = e, this.subscriptions = {
    ...
    J(t), r.emit(a.SHAPE_MOUSE_DOWN, this.shape, u(t)), setTimeout(() => {
      r.emit(
        a.SHAPE_MOVE_START,
        this.shape,
...
function ee() {
  this.draw = (e) => {
    ...
    if (i.setAttribute("viewBox", o), t && !e.options.groupChildShapes) {
      const n = [];
      e.getChildren(!0).filter((p) => p.svg).forEach((p) => {
    ...
    const p = document.createElement("div");
    p.appendChild(l);
    const d = p.innerHTML, g = new Image(), b = new Blob([d], { type: "image/svg+xml" }), V = window.URL || window.webkitURL || window, w = await W(b);
...
function P() {
  this.root = null, this.points = [], this.svg = null, this.groupHelper = null, this.eventListener = new te(this), this.options = {
    id: "",
    name: "Unnamed shape",
    maxPoints: -1,
    fillGradient: null,
    ...
    return this.root = e, this.root.style.position = "relative", this.shapeMenu = new le(this), this.setOptions(t), this.groupHelper = new et(this), i && i.length && (this.setupPoints(i, S({}, this.options.pointOptions)), this.redraw()), this.eventListener.run(), this.shapeMenu && typeof this.shapeMenu == "object" && this.shapeMenu.updateContextMenu(), s && this.applyDisplayMode(), (i && i.length || this.options.forceCreateEvent) && r.emit(a.SHAPE_CREATE, this, {}), this;
  }, this.setOptions = (e) => {
