...
const r = new lt(), pt = (e) => e * (Math.PI / 180), At = (e) => e * (180 / Math.PI), O = (e, t, i, s, o) => {
  if (e === 0)
    return [t, i];
  const n = pt(e), h = (t - s) * Math.cos(n) - (i - o) * Math.sin(n) + s, l = (t - s) * Math.sin(n) + (i - o) * Math.cos(n) + o;
  return [h, l];
}, P = (e, t, i, s) => Math.sqrt(Math.pow(i - e, 2) + Math.pow(s - t, 2)), dt = (e, t, i, s, o, n) => {
  ...
  const i = (p, d, c) => d.x <= Math.max(p.x, c.x) && d.x >= Math.min(p.x, c.x) && d.y <= Math.max(p.y, c.y) && d.y >= Math.min(p.y, c.y), s = (p, d, c) => {
    let m = (d[1] - p[1]) * (c[0] - d[0]) - (d[0] - p[0]) * (c[1] - d[1]);
    return m === 0 ? 0 : m > 0 ? 1 : 2;
  }, o = (p, d, c, m) => {
    let x = s(p, d, c), N = s(p, d, m), D = s(c, m, p), v = s(c, m, d);
    return x !== N && D !== v || x === 0 && i(p, c, d) || N === 0 && i(p, m, d) || D === 0 && i(c, p, m) ? !0 : !!(v === 0 && i(c, d, m));
  };
  if (e.length < 3)
    return !1;
  ...
  return h % 2 === 1;
}, tt = (e, t, i, s) => !e && !t || !i || !s ? [i, s] : e && t ? [e, t] : (e || (e = t * (i / s)), t || (t = e * (s / i)), [e, t]), J = (e, t, i, s) => {
  const o = s.scaleFactorX || 1, n = s.scaleFactorY || 1, h = s.offsetX || 0, l = s.offsetY || 0, p = s.flippedX || !1, d = s.flippedY || !1;
  return i === G.CURRENT_TO_ORIGINAL ? ([e, t] = k(e, t, p, d, s), e -= h, t -= l, e *= 1 / o, t *= 1 / n) : i === G.ORIGINAL_TO_CURRENT && (e *= o, t *= n, e += h, t += l, [e, t] = k(e, t, p, d, s)), [e, t];
}, k = (e, t, i, s, o) => (i && (e = M(o.right - e) + o.left), s && (t = M(o.bottom - t) + o.top), [e, t]), G = {
...
function Mt(e, t, i) {
  const s = {};
  return i.isMergeableObject(e) && X(e).forEach(function(o) {
    s[o] = L(e[o], i);
  }), X(t).forEach(function(o) {
    Ct(e, o) || (et(e, o) && i.isMergeableObject(t[o]) ? s[o] = vt(o, i)(e[o], t[o], i) : s[o] = L(t[o], i));
  }), s;
}
const T = (e, t, i) => {
  i = i || {}, i.arrayMerge = i.arrayMerge || yt, i.isMergeableObject = i.isMergeableObject || gt, i.cloneUnlessOtherwiseSpecified = L;
  const s = Array.isArray(t), o = Array.isArray(e);
  return s === o ? s ? i.arrayMerge(e, t, i) : Mt(e, t, i) : L(t, i);
};
T.all = function(t, i) {
  if (!Array.isArray(t))
...
const _ = (e, t = !0) => {
  ...
  return t;
}, M = (e) => e < 0 ? -e : e, Pt = (e) => new Promise((t) => {
  setTimeout(() => {
    t();
  }, e);
}), u = (e, t = {}) => {
...
function Tt(e, t, i = null, s = {}) {
  this.panel = null, this.container = t, this.items = e, this.event = i || "contextmenu", this.options = s, this.listeners = {}, this.origEvent = null, this.cursorX = 0, this.cursorY = 0, this.overflowY = "", this.maxImageHeight = 0, this.subscriptions = {}, this.init = () => (Object.assign(this, new It(this)), this.listener = (o) => (this.onEvent(o), !1), this.container.addEventListener(this.event, this.listener), C.emit(w.CREATE, this, { owner: this }), this), this.onEvent = (o) => {
    ...
    const h = (l) => {
      !this.origEvent || (C.emit(o, this.origEvent.target, wt(l, {
...
function he() {
  return this.options = {
    ...
    forceDisplay: !1,
    createDOMElement: !1
  }, this.x = 0, this.y = 0, this.element = null, this.guid = V(), this.subscriptions = {}, this.dragHorizontal = !1, this.dragVertical = !1, this.init = (e, t, i = null) => (this.x = parseInt(e), this.y = parseInt(t), this.setOptions(b({}, i)), this.setEventListeners(), r.emit(g.POINT_ADDED, this), this), this.setOptions = (e) => {
    ...
    const [s, o] = O(e, this.x, this.y, t, i);
    this.x = s, this.y = o;
    ...
    if (r.emit(g.POINT_MOUSE_MOVE, this, u(e)), e.buttons !== 1 || !this.options.canDrag || !f.draggedShape || f.draggedShape.draggedPoint !== this)
      return;
    const t = this.x, i = this.y, s = _(this.element.parentNode, !0);
  ...
  }, this.distance = (e) => P(this.x, this.y, e.x, e.y), this;
}
const g = {
  POINT_ADDED: "create",
...
function re(e) {
  this.rotateBox = e, this.subscriptions = {
    ...
    if (h === null)
      return;
    let l = h;
    this.previousAngle && (l -= this.previousAngle), this.previousAngle = h, r.emit(H.ROTATE_BOX_ROTATE, this.rotateBox, { angle: l });
  }, this.calcAngle = (t, i, s, o) => {
    const n = this.calcHypotenuse(t, i, s, o);
    if (n <= 0)
      return null;
    const h = this.calcCathetus(t, i, s, o), l = this.calcStartAngle(t, i, s, o);
    return Math.round(At(Math.asin(h / n)) + l + this.initialAngle);
  }, this.calcHypotenuse = (t, i, s, o) => P(t, i, s, o), this.calcCathetus = (t, i, s, o) => {
    if (t <= s && i <= o)
      return P(t, i, t, o);
    if (t >= s && i <= o)
      return P(t, i, s, i);
...
function le() {
  this.draw = (e) => {
    ...
    e.points[0] && !e.points[0].element && await Pt(1);
    let i = t || e;
    e.points.filter((s) => s.element).forEach((s) => {
      s.element.parentNode !== e.root && e.root.appendChild(s.element), s.options.zIndex = e.options.zIndex + 2, !e.options.visible && !s.options.forceDisplay ? s.options.visible = !1 : e.options.displayMode !== A.DEFAULT && (s.options.visible = !0), s.redraw(), f.isNormalShape(i) && ((i.options.displayMode === A.SELECTED || s.options.forceDisplay) && i.options.visible ? s.element.style.display = "" : s.element.style.display = "none");
    });
    ...
    if (t && t.options.groupChildShapes) {
      ...
      return [
        this.getPolygonPathForShape(e, i, this.getMaxStrokeWidth(t)),
        this.getPolygonPathForChildren(e, i)
      ].join("");
    } else {
      const i = e.getPosition(e.options.groupChildShapes);
      let s = [
        this.getPolygonPathForShape(e, i, this.getMaxStrokeWidth(e)),
        this.getPolygonPathForChildren(e, i)
      ].join("");
    ...
    return e.options.displayAsPath && e.options.groupChildShapes && e.getChildren().forEach((s) => {
      s.calcPosition(), i.push(this.getPolygonPathForShape(s, t, this.getMaxStrokeWidth(s)));
    }), i;
  }, this.getPolygonPathForShape = (e, t, i) => ["M ", e.points.map((s) => {
    let o = s.x - t.left, n = s.y - t.top;
    return o <= 0 ? o += i : s.x >= t.right && (o -= i), n <= 0 ? n += i : s.y >= t.bottom && (n -= i), [o, ",", n].join("");
  }), " Z"].join(" "), this.redrawResizeBox = (e) => {
    if (e.options.displayMode !== A.SCALE || !e.options.canScale) {
    ...
    this.setupBox(e, e.resizeBox, A.SCALE);
  }, this.redrawRotateBox = (e) => {
    if (e.options.displayMode !== A.ROTATE || !e.options.canRotate) {
    ...
    this.setupBox(e, e.rotateBox, A.ROTATE);
  }, this.setupBox = (e, t, i) => {
  ...
  }, this.toPng = (e, t = U.DATAURL, i = null, s = null, o = null) => new Promise(async (n) => {
    const h = e.options.zoomLevel || 1;
    e.calcPosition();
    const l = e.getPosition(o || e.options.groupChildShapes);
    [i, s] = tt(i, s, l.width / h, l.height / h);
    const p = this.getSvg(e, o);
    p.setAttribute("width", l.width / h), p.setAttribute("height", l.height / h);
    for (let v of p.querySelectorAll("image"))
      if (v.getAttribute("href") && v.getAttribute("href").length) {
        const z = await K(await (await fetch(v.getAttribute("href"))).blob());
        v.setAttribute("href", z);
      }
    const d = document.createElement("div");
    d.appendChild(p);
    const c = d.innerHTML, m = new Image(), x = new Blob([c], { type: "image/svg+xml" }), N = window.URL || window.webkitURL || window, D = await K(x);
    m.addEventListener("load", () => {
      const v = document.createElement("canvas");
      m.width = l.width / h, m.height = l.height / h, v.width = m.width, v.height = m.height;
      const z = v.getContext("2d");
      z.drawImage(m, 0, 0), z.scale(i, s), N.revokeObjectURL(D);
      const Z = v.toDataURL("image/png");
      if (t === U.BLOB) {
        n(Bt(Z));
        return;
      }
...
function pe(e) {
  this.shape = e, this.subscriptions = {
    ...
    const i = this.shape.getRootParent(!0);
    if (i) {
      r.emit(H.ROTATE_BOX_ROTATE, i.rotateBox, { angle: t.angle });
      return;
    }
    ...
    const l = i.left + s, p = i.top + o, d = _(this.shape.root, !0), c = this.shape.getBounds();
    return (l < c.left || l + i.width > c.right) && (s = 0), (p < c.top || p + i.height > c.bottom) && (o = 0), n < l + d.left && (s = n - (l + d.left)), h < p + d.top && (o = h - (p + d.top)), n > l + i.width + d.left && (s = n - (i.width + d.left + i.left)), h > p + i.height + d.right && (o = h - (i.height + d.top + i.top)), [s, o];
  }, this.onPointAdded = (t) => {
...
const a = {
  ...
  for (let n in t.features) {
    const h = t.features[n], l = de(h, n, i, e);
  ...
  for (let p in n) {
    ...
    else if (d.id += "_" + p, d.name += " " + p, i.onlyData)
      h.children.push({
        points: n[p].cords,
        options: d,
        ...n[p].dims
  ...
  return (l.left < 0 || l.top < 0) && (i.scale || i.width || i.height) && h.moveTo(0, 0, !1, !1), S(i.scale) ? h.scaleBy(i.scale, i.scale, !0) : (S(i.width) || S(i.height)) && h.scaleTo(i.width, i.height), h;
}, ue = (e) => {
  ...
  for (let s of t) {
    const o = s[0], n = [];
    let h = 1 / 0, l = -1 / 0, p = 1 / 0, d = -1 / 0;
    for (let c of o) {
      const [m, x] = [c[0], -c[1]];
      m < h && (h = m), m > l && (l = m), x < p && (p = x), x > d && (d = x), n.push({ x: m, y: x });
    }
    i.push({ cords: n, dims: { left: h, top: p, bottom: d, right: l, width: l - h, height: d - p } });
  }
  return i;
};
function fe() {
  this.shapes = {}, this.visibleShapes = {}, this.activeShape = null, this.draggedShape = null, this.shapeOnCursor = null, this.containerEventListeners = [], this.init = () => (this.setEventListeners(), this), this.setEventListeners = () => {
  ...
  }, this.createShape = (e, t, i, s = !0) => new R().init(e, t, i, s), this.onShapeCreated = (e) => {
    const t = e.target;
    ...
    typeof e.options.prevZIndex < "u" && y.updateOptions(e), e.options.displayMode !== A.DEFAULT && e.switchDisplayMode(A.DEFAULT), e.options.groupChildShapes && e.getChildren(!0).forEach((t) => {
      typeof t.options.prevZIndex < "u" && (y.updateOptions(t), t.options.displayMode !== A.DEFAULT && t.switchDisplayMode(A.DEFAULT));
    });
  }, this.addContainerEvents = (e) => {
    this.addContainerEvent(e.root, "mousemove", this.mousemove), this.addContainerEvent(e.root, "mouseup", this.mouseup, e.options.id), this.addContainerEvent(e.root, "dblclick", this.doubleclick), this.addContainerEvent(e.root, "contextmenu", this.contextmenu), this.addContainerEvent(e.root, "mouseleave", this.mouseleave), r.emit(Ee.MANAGER_ADD_CONTAINER_EVENT_LISTENERS, e.root);
    ...
    for (let h in o) {
      const l = o[h];
      l.options.id && this.findShapeById(l.options.id) || (n.push(new R().fromJSON(e, l, !0, s)), i && typeof i == "function" && i(h / o.length));
    }
    return n;
...
function me(e) {
  this.shape = e, this.moveTo = (t, i, s = !0, o = !0, n = !1) => {
    const h = this.shape.getBounds(), l = this.shape.getPosition(this.shape.options.groupChildShapes);
    let p = t, d = i;
    o && (p = t + l.width > h.right ? h.right - l.width : t, d = i + l.height > h.bottom ? h.bottom - l.height : i), this.moveBy(p - l.left, d - l.top, s, n);
    ...
    s && (o ? this.shape.svg && (this.shape.svg.style.left = this.shape.left + "px", this.shape.svg.style.top = this.shape.top + "px") : this.shape.redraw()), n.length && this.shape.options.groupChildShapes && n.forEach((h) => h.moveBy(t, i, s, o)), o && !this.shape.getParent() && (y.redrawResizeBox(this), y.redrawRotateBox(this));
    ...
    let h = M(n.left) + t > o.right && o.right !== -1 ? o.right - M(n.left) : t, l = M(n.top) + i > o.bottom && o.bottom !== -1 ? o.bottom - M(n.top) : i, p = M(h / n.width), d = M(l / n.height);
    ...
    this.shape.calcPosition();
    const n = this.shape.getPosition(this.shape.options.groupChildShapes);
    [i, s] = this.getRotateCenter(i, s), !(o && (!this.shape.isInBounds(...O(t, n.left, n.top, i, s)) || !this.shape.isInBounds(...O(t, n.right, n.top, i, s)) || !this.shape.isInBounds(...O(t, n.left, n.bottom, i, s)) || !this.shape.isInBounds(...O(t, n.right, n.bottom, i, s)))) && (this.shape.points.forEach((h) => {
      typeof h.rotateBy == "function" ? h.rotateBy(t, i, s) : [h.x, h.y] = O(t, h.x, h.y, i, s);
    }), this.shape.options.rotateAngle += t, this.shape.options.groupChildShapes && this.shape.getChildren(!0).forEach((h) => {
      h.points.forEach((l) => {
        typeof l.rotateBy == "function" ? l.rotateBy(t, i, s) : [l.x, l.y] = O(t, l.x, l.y, i, s);
      });
    }));
  }, this.getRotateCenter = (t, i) => {
    const s = this.shape.getRootParent(!0);
    let o, n;
    return s && s.options.groupChildShapes ? [o, n] = s.getCenter(s.options.groupChildShapes) : [o, n] = this.shape.getCenter(this.shape.options.groupChildShapes), this.shape.initCenter && !t && !i && ([t, i] = this.shape.initCenter), t || (t = o), i || (i = n), [t, i];
  }, this.flip = (t, i, s) => {
    if (!t && !i)
      return;
    ...
    n && n.forEach((h) => {
      t && (h.options.flippedX = !h.options.flippedX, h.options.flippedY = !h.options.flippedY), h.shape.points.forEach((l) => h.shape.flipPoint(l, t, i, s));
    });
...
function Se(e) {
  this.shape = e, this.contextMenu = null, this.updateContextMenu = () => {
    ...
    const t = [
      ...
      { id: "i" + e.guid + "_clone", title: "Clone", image: Jt },
    ...
    this.contextMenu.on("click", (s) => {
      switch (s.itemId) {
        ...
        case "i" + this.shape.guid + "_ungroup":
          i = this.shape.getRootParent(), t = i || this.shape, t.setOptions({ groupChildShapes: !1, displayAsPath: !1 }), t.switchDisplayMode(A.DEFAULT), t.getChildren().forEach((o) => o.switchDisplayMode(A.DEFAULT));
          break;
        case "i" + this.shape.guid + "_topath":
          i = this.shape.getRootParent(), t = i || this.shape, t.setOptions({ groupChildShapes: !0, displayAsPath: !0 }), t.switchDisplayMode(A.SELECTED), t.getChildren().forEach((o) => o.switchDisplayMode(A.SELECTED));
          break;
        case "i" + this.shape.guid + "_toshapes":
          i = this.shape.getRootParent(), t = i || this.shape, t.setOptions({ displayAsPath: !1 }), t.switchDisplayMode(A.SELECTED), t.getChildren().forEach((o) => o.switchDisplayMode(A.SELECTED));
          break;
    ...
    const s = i.getRootParent();
    s && s.options.groupChildShapes && (i = s);
    const o = await i.toPng(U.BLOB);
    this.saveToFile(o, this.getExportFileName("png"));
  }, this.onGetBase64ToClipboardClick = async (t) => {
    let i = this.shape;
    const s = i.getRootParent();
    s && s.options.groupChildShapes && (i = s), await window.navigator.clipboard.writeText(await i.toPng(U.DATAURL));
...
function R() {
  this.root = null, this.points = [], this.svg = null, this.polygon = null, this.groupHelper = null, this.eventListener = null, this.options = {
    ...
    flippedX: !1,
    flippedY: !1
  }, this.left = 0, this.top = 0, this.right = 0, this.bottom = 0, this.width = 0, this.height = 0, this.guid = V(), this.children = [], this.resizeBox = null, this.rotateBox = null, this.initCenter = null, this.shapeMenu = null, this.transformer = null, this.init = (e, t = null, i = null, s = !0) => {
    if (!e) {
    ...
    return this.root = e, this.root.style.position = "relative", this.shapeMenu = new Se(this), this.eventListener = new pe(this), this.transformer = new me(this), this.setOptions(t), this.groupHelper = new ht(this), i && i.length && this.setupPoints(i, b({}, this.options.pointOptions)), this.eventListener.run(), s && (this.applyDisplayMode(), this.redraw()), (i && i.length || this.options.forceCreateEvent) && r.emit(a.SHAPE_CREATE, this, {}), this;
  }, this.setOptions = (e) => {
    ...
    if (!i || !i.length)
      return null;
    const s = i.map(([o, n]) => ({ x: o, y: n, d: P(e, t, o, n) })).reduce((o, n) => o.d < n.d ? o : n);
    ...
    y.changeShapeZIndex(this, e);
  }, this.isInBounds = (e, t) => {
    const [i, s] = this.transformer.getMaxPointSize(), o = this.getBounds();
    return e >= o.left + i / 2 && e <= o.right - i / 2 && t >= o.top + s / 2 && t <= o.bottom - s / 2;
  }, this.redraw = () => {
    this.applyDisplayMode(), y.draw(this), this.options.groupChildShapes && this.redrawChildren();
  }, this.redrawChildren = () => {
    this.getChildren().forEach((e) => {
      this.options.displayAsPath ? this.options.displayMode === A.SELECTED && e.points.filter((t) => t.element).forEach((t) => t.redraw()) : e.redraw();
    });
  }, this.applyDisplayMode = () => {
    this.points.filter((e) => typeof e.setOptions == "function").forEach((e) => {
      const t = { zIndex: this.options.zIndex + 15 };
      t.createDOMElement = this.options.displayMode !== A.DEFAULT, e.setOptions(t), t.createDOMElement && !e.element && e.redraw(), e.element && (e.element.style.zIndex = e.options.zIndex, this.options.displayMode !== A.SELECTED && !e.options.forceDisplay ? e.element.style.display = "none" : e.element.style.display = "");
    ...
    e || (e = this.getNextDisplayMode()), (e === A.SCALE && !this.options.canScale || e === A.ROTATE && !this.options.canRotate || e === A.SELECTED && this.points.length && !this.options.pointOptions.canDrag) && (e = A.DEFAULT), this.options.displayMode = e, this.options.simpleMode ? this.applyDisplayMode() : this.redraw(), e === A.DEFAULT && this.options.groupChildShapes && setTimeout(() => {
    ...
    const t = {};
    return t.left = e.map((i) => i[0]).reduce((i, s) => s < i ? s : i, 99999999), t.top = e.map((i) => i[1]).reduce((i, s) => s < i ? s : i, 99999999), t.right = e.map((i) => i[0]).reduce((i, s) => s > i ? s : i, -99999999), t.bottom = e.map((i) => i[1]).reduce((i, s) => s > i ? s : i, -999999999), t.width = M(t.right - t.left) || 1, t.height = M(t.bottom - t.top) || 1, t;
  ...
  }, this.getShapeSvg = () => y.getShapeSvg(this), this.toSvg = (e = null) => y.toSvg(this, e), this.toPng = (e = U.DATAURL, t = null, i = null, s = null) => y.toPng(this, e, t, i, s), this.toJSON = (e = !0, t = !1) => JSON.stringify(this.getJSON(e, t)), this.clone = (e = {}, t = !0) => {
    const i = b({}, this.getJSON(t));
    i.parent_guid = this.guid, i.options = b(i.options, e);
    const s = new R().fromJSON(this.root, i, t);
    ...
    if (this.root = e, f.findShapeById(o.options.id) && (o.options.id += "_" + f.length(), o.options.name += " " + f.length()), this.svg ? this.setOptions(o.options) : (o.options.forceCreateEvent = !1, this.init(e, o.options, null, !1)), o.points.forEach((n) => {
      ...
      n.parent_guid = this.guid, this.addChild(new R().fromJSON(e, n));
    })), s) {
  ...
  ), this.mapOriginalPointToCurrent = (e, t) => J(
    e,
    t,
...
function at() {
  this.left = 0, this.top = 0, this.right = 0, this.bottom = 0, this.width = 0, this.height = 0, this.shape = null, this.guid = V(), this.options = {
    ...
    this.left_top = this.shape.putPoint(this.left, this.top, { id: this.shape.guid + "_left_top", style: { backgroundImage: "url('" + kt + "')" } }), this.center_top = this.shape.putPoint(this.left + this.width / 2, this.top, { id: this.shape.guid + "_center_top", style: { backgroundImage: "url('" + zt + "')" } }), this.right_top = this.shape.putPoint(this.right, this.top, { id: this.shape.guid + "_right_top", style: { backgroundImage: "url('" + Qt + "')" } }), this.right_center = this.shape.putPoint(this.right, this.top + this.height / 2, { id: this.shape.guid + "_right_center", style: { backgroundImage: "url('" + Wt + "')" } }), this.right_bottom = this.shape.putPoint(this.right, this.bottom, { id: this.shape.guid + "_right_bottom", style: { backgroundImage: "url('" + Ft + "')" } }), this.center_bottom = this.shape.putPoint(this.left + this.width / 2, this.bottom, { id: this.shape.guid + "_center_bottom", style: { backgroundImage: "url('" + Nt + "')" } }), this.left_bottom = this.shape.putPoint(this.left, this.bottom, { id: this.shape.guid + "_left_bottom", style: { backgroundImage: "url('" + Ht + "')" } }), this.left_center = this.shape.putPoint(this.left, this.top + this.height / 2, { id: this.shape.guid + "_left_center", style: { backgroundImage: "url('" + Gt + "')" } }), this.setPointsOptions();
...
try {
  window.ResizeBox = at, window.SmartShape = R, window.RotateBox = rt, window.SmartShapeManager = f, window.SmartShapeGroupHelper = ht, window.SmartShapeDisplayMode = A, window.ShapeEvents = a, window.createEvent = u, window.getMousePos = j, window.getMouseCursorPos = Q;
} catch {
}
export {
  r as EventsManager,
