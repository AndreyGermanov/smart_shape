...
const h = new X(), K = (t) => t * (Math.PI / 180), q = (t) => t * (180 / Math.PI), I = (t, s, e, i, o) => {
  const n = K(t), a = (s - i) * Math.cos(n) - (e - o) * Math.sin(n) + i, p = (s - i) * Math.sin(n) + (e - o) * Math.cos(n) + o;
  return [a, p];
}, P = (t, s, e, i) => Math.sqrt(Math.pow(e - t, 2) + Math.pow(i - s, 2)), $ = (t, s) => {
  const e = (d, A, c) => A.x <= Math.max(d.x, c.x) && A.x >= Math.min(d.x, c.x) && A.y <= Math.max(d.y, c.y) && A.y >= Math.min(d.y, c.y), i = (d, A, c) => {
    ...
    let D = i(d, A, c), M = i(d, A, x), m = i(c, x, d), v = i(c, x, A);
    return D !== M && m !== v || D === 0 && e(d, c, A) || M === 0 && e(d, x, A) || m === 0 && e(c, d, x) ? !0 : !!(v === 0 && e(c, A, x));
  };
  if (t.length < 3)
    return !1;
  ...
  return a % 2 === 1;
}, j = (t, s, e, i) => !t && !s || !e || !i ? [e, i] : t && s ? [t, s] : (t || (t = s * (e / i)), s || (s = t * (i / e)), [t, s]), w = (t, s = !0) => {
  let e = 0, i = 0;
  if (!s)
  ...
  return !1;
}, b = (t) => typeof t < "u" && t !== null, C = (t, s) => t && typeof t == "object" && s && typeof s == "object" ? Object.assign(t, s) : t, tt = (t) => {
...
function nt(t, s, e = null) {
  this.panel = null, this.container = s, this.items = t, this.event = e || "contextmenu", this.listeners = {}, this.origEvent = null, this.cursorX = 0, this.cursorY = 0, this.overflowY = "", this.maxImageHeight = 0, this.subscriptions = {}, this.init = () => (Object.assign(this, new it(this)), this.container.addEventListener(this.event, (i) => (this.onEvent(i), !1)), S.emit(_.CREATE, this, { owner: this }), this), this.onEvent = (i) => {
    ...
    const n = (a) => {
      !this.origEvent || (S.emit(i, this.origEvent.target, ot(a, {
...
function ht() {
  this.menus = [], this.create = (t, s, e) => new nt(t, s, e).init(), S.subscribe(_.CREATE, (t) => {
  ...
  return this.options = {
    ...
    if (t == null && (t = this.element), this.options.id && (this.element.id = this.options.id), t.className = this.options.classes, t.style = this.options.style, typeof this.options.style == "object")
      for (let s in this.options.style)
        t.style[st(s)] = this.options.style[s];
    ...
    h.emit(g.POINT_MOUSE_DOWN, this, l(t)), t.buttons === 1 && this.options.canDrag && (h.emit(g.POINT_DRAG_START, this, l(t)), F(t));
  }, this.mousemove = (t) => {
...
function Pt(t) {
  this.shape = t, this.subscriptions = {
    ...
    F(s), h.emit(r.SHAPE_MOUSE_DOWN, this.shape, l(s)), setTimeout(() => {
  ...
  this.draw = (t) => {
    ...
    if (t.options.classes && s.setAttribute("class", t.options.classes), !(!b(t.options.style) || typeof t.options.style != "object"))
      for (let e in t.options.style)
        e === "fill" && this.checkFillAttributes(t) || e.search("stroke") !== -1 && this.checkStrokeAttributes(e, t) || (s.style[e] = t.options.style[e]);
  }, this.checkFillAttributes = (t) => t.options.fillImage && typeof t.options.fillImage == "object" || t.options.fillGradient && typeof t.options.fillGradient == "object" || t.options.fill !== "none" && t.options.fill, this.checkStrokeAttributes = (t, s) => t === "stroke" && s.options.stroke && s.options.stroke !== "#000000" || t === "stroke-width" && s.options.strokeWidth || t === "stroke-linecap" && s.options.strokeLinecap && s.options.strokeLinecap !== "square" || t === "stroke-dasharray" && s.options.strokeDasharray, this.toSvg = (t, s = null) => {
    ...
    for (let m of p.querySelectorAll("image"))
      if (m.getAttribute("href") && m.getAttribute("href").length) {
        const v = await H(await (await fetch(m.getAttribute("href"))).blob());
        m.setAttribute("href", v);
      }
    const d = document.createElement("div");
    d.appendChild(p);
    const A = d.innerHTML, c = new Image(), x = new Blob([A], { type: "image/svg+xml" }), D = window.URL || window.webkitURL || window, M = await H(x);
    c.addEventListener("load", () => {
      const m = document.createElement("canvas");
      c.width = a.width, c.height = a.height, m.width = c.width, m.height = c.height;
      const v = m.getContext("2d");
      v.drawImage(c, 0, 0), v.scale(e, i), D.revokeObjectURL(M);
      const V = m.toDataURL("image/png");
      if (s === U.BLOB) {
        n(tt(V));
        return;
      }
  ...
  this.shapes = [], this.activeShape = null, this.draggedShape = null, this.shapeOnCursor = null, this.containerEventListeners = [], this.init = () => (this.setEventListeners(), this), this.setEventListeners = () => {
    ...
    if (!(typeof t.id < "u" && (t.id.search("_resizebox") !== -1 || t.id.search("_rotatebox") !== -1))) {
      if (this.activeShape && this.deactivateShape(this.activeShape), t.options.moveToTop) {
        ...
        t.options.prevZIndex = t.options.zIndex, t.options.zIndex += i, y.updateOptions(t), t.options.groupChildShapes && t.getChildren(!0).forEach((o) => {
    ...
    typeof t.options.prevZIndex < "u" && y.updateOptions(t), t.options.displayMode !== u.DEFAULT && t.switchDisplayMode(u.DEFAULT), t.getChildren(!0).forEach((s) => {
      typeof s.options.prevZIndex < "u" && (y.updateOptions(s), s.options.displayMode !== u.DEFAULT && s.switchDisplayMode(u.DEFAULT));
    });
    ...
    if (!!this.activeShape && !(!this.activeShape.options.canAddPoints || this.activeShape.draggedPoint || this.activeShape.points.length > 2) && (this.activeShape.options.maxPoints === -1 || this.activeShape.points.length < this.activeShape.options.maxPoints)) {
      ...
      const [s, e] = W(l(t, { target: this.activeShape }));
...
function Lt(t) {
  this.shape = t, this.contextMenu = null, this.updateContextMenu = () => {
    ...
    t.svg && (this.contextMenu = z.create([], t.svg), t.options.canAddPoints && this.contextMenu.addItem("i" + t.guid + "_add_point", "Add Point", G), this.displayGroupItems(), this.setEventListeners());
  }, this.getMenuItems = () => {
    const s = [
    ...
    return t.options.canAddPoints && s.push({ id: "i" + t.guid + "_add_point", title: "Add Point", image: G }), s;
  }, this.setEventListeners = () => {
...
function B() {
  this.root = null, this.points = [], this.svg = null, this.groupHelper = null, this.eventListener = new Pt(this), this.options = {
    ...
    if (o.width === t && o.height === s)
      return;
    [t, s] = this.applyScaleRestriction(...j(t, s, o.width, o.height)), o.width >= 10 && t < 10 && (t = 10), o.height >= 10 && s < 10 && (s = 10);
    ...
    return e && (i = i.map((o) => [o[0] + w(this.root).left, o[1] + w(this.root).top])), $(i, [t, s]);
  }, this.addEventListener = (t, s) => this.eventListener.addEventListener(t, s), this.removeEventListener = (t, s) => {
    this.eventListener.removeEventListener(t, s);
  }, this.show = () => {
    this.setOptions({ visible: !0 }), this.redraw();
  ...
  }, this.toSvg = (t = null) => y.toSvg(this, t), this.toPng = (t = U.DATAURL, s = null, e = null, i = null) => y.toPng(this, t, s, e, i), this.toJSON = (t = !0) => JSON.stringify(this.getJSON(t)), this.clone = (t = {}) => {
    ...
    const e = new B().fromJSON(this.root, JSON.stringify(s));
